...
################################################################################
# ESTE SCRIPT TEM COMO PRINCIPAL OBJETIVO INSTALAR UM SERVIDOR WEB             #
# APACHE, VAI BAIXAR UM TEMPLATE DO SITE FREE CSS TEMPLATES E CONFIGURAR       #
# COMO SITE PADRÃO DO SERVIDOR                                                 #
# Requisitos:                                                                  #
...
echo "######################################"
echo "#                                    #"
echo "# SEJA BEM-VINDO AO CONF MASTER HTTP #"
echo "#                                    #"
echo "# Feito por: Emily Karoline Gonzaga  #"
echo "# Última atualização: 07/11/2024     #"
echo "######################################"
echo ""
